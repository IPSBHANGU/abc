package com.aosmp.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String AOSMPSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, AOSMPSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, AOSMPSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(AOSMPSETTINGSNS, "interval");
            if(newInterval != null)
